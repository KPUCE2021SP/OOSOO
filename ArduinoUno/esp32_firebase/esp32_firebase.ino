...
/* 3. Define the RTDB URL        DB주소*/  
#define DATABASE_URL "ecobasket-c3ef9-default-rtdb.asia-southeast1.firebasedatabase.app" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
